...
V12.2 ACCOUNT FIX
-----------------
Run SUPABASE-V12.2-ACCOUNT-NOTIFICATION-PROFILE-FIX.sql once after the V12.1 SQL.
It enables customer notifications, order/payment notification triggers, and secure customer profile-photo uploads.
Profile name/phone/home/delivery address are saved in Supabase Auth user metadata so they do not depend on optional Customers columns.
